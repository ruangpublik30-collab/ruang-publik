    ...
    return (
        <>
            ...
            <article className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8 prose prose-lg prose-neutral">
                <h1 className="text-2xl font-bold mt-10 mb-3">Tentang Runag Publik</h1>

                <h2 className="text-2xl font-bold mt-10 mb-3">Siapa Kami?</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold mt-10 mb-3">Misi</h2>
                <ul>
                ...
                <h2 className="text-2xl font-bold mt-10 mb-3">Fokus Pembahasan</h2>
                <ul>
                ...
                <h2 className="text-2xl font-bold mt-10 mb-3">Kontak</h2>
                <p>
                    Untuk pertanyaan, kerja sama, atau klarifikasi:
                    <br />
                    Email: <a href="mailto:kontak@ruangpublik.fun">ruangpublik30@gmail.com</a>
                </p>
            </article>
        </>
    )
